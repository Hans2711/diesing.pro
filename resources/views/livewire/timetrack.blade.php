<div class="space-y-5">
    ...
    <div class="flex flex-wrap items-end gap-4 bg-gray-100 p-4 rounded">
        <div>
            <label for="start" class="block text-sm mb-1">Von</label>
            <input id="start" type="datetime-local" class="input" wire:model.lazy="searchStart">
        </div>
        <div>
            <label for="end" class="block text-sm mb-1">Bis</label>
            <input id="end" type="datetime-local" class="input" wire:model.lazy="searchEnd">
        </div>
    </div>
