<div>
    ...
    <a wire:click="generateTeams" wire:loading.class="opacity-50" class="btn btn-secondary mt-3 md:w-1/3">
        <img class="w-6 h-5 invert dark:invert-0" src="{{ Vite::asset('resources/icons/shuffle.svg') }}" />
    </a>
