...
@section('content')
    ...
    <div class="xl:w-1/2 w-full">
        <div class="sm:columns-1 columns-1 mt-2">
            <div class="form-group mt-4 sm:mt-0">
                <div>
                    ...
                    <select name="recepient" class="rounded">
        ...
        <div class="sm:columns-2 columns-1 mt-2">
            <div class="form-group mt-4 sm:mt-0">
                @include('global.partials..floating-label-input', ['id' => 'name', 'name' => 'name', 'label' => 'Name', 'wrapperClass' => 'w-full sm:w-auto', 'tabindex' => 1, 'required' => true])
            </div>
            <div class="form-group mt-4 sm:mt-0">
                @include('global.partials..floating-label-input', ['id' => 'firma', 'name' => 'firma', 'label' => __('text.company'), 'wrapperClass' => 'w-full sm:w-auto', 'tabindex' => 2])
            </div>
        </div>
        <hr class="md:my-5 mb-0 mt-5" />
        <div class="sm:columns-2 columns-1 mt-2">
            <div class="form-group mt-4 sm:mt-0">
                @include('global.partials..floating-label-input', ['id' => 'email', 'name' => 'email', 'label' => __('text.email'), 'wrapperClass' => 'w-full sm:w-auto', 'tabindex' => 3, 'required' => true])
            </div>
            <div class="form-group mt-4 sm:mt-0">
                @include('global.partials..floating-label-input', ['id' => 'tel', 'name' => 'tel', 'label' => __('text.mobile'), 'wrapperClass' => 'w-full sm:w-auto', 'tabindex' => 4, 'required' => true])
            </div>
        </div>
