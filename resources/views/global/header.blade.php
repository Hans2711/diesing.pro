...
<aside
    ...
    md:translate-x-0 md:relative md:sticky md:top-0 md:w-64
    md:h-screen md:block
    bg-tertiary dark:bg-gray-900 text-black dark:text-white shadow-lg"
    @click.away="sidebarOpen = false"
>
    <div class="h-full flex flex-col">
        <div class="sticky top-0 bg-tertiary z-10">
            <!-- Logo + Language -->
