<footer class="bg-white border-t border-gray-200 py-8 dark:border-gray-700 dark:text-white dark:bg-gray-900">
    <div class="container mx-auto text-center">
        <div class="flex justify-center space-x-8 mb-4">
            <a alt="{{ __('text.imprint') }}" wire:navigate.hover href="{{url(Config::get('app.locale') . '/' . __('url.imprint'))}}" class="text-gray-600 dark:text-white dark:hover:text-gray-100 hover:text-gray-900">{{ __('text.imprint') }}</a>
            <a alt="{{ __('text.data-protection') }}" wire:navigate.hover href="{{url(Config::get('app.locale') . '/' . __('url.data-protection'))}}" class="text-gray-600 dark:text-white dark:hover:text-gray-100 hover:text-gray-900">{{ __('text.data-protection') }}</a>
        </div>
        <div class="flex justify-center space-x-8 mb-4">
            <a alt="{{ __('alt.instagram') }}" href="https://www.instagram.com/hans.dsg" target="_blank" class="">
            ...
            <a alt="{{ __('alt.linkedin') }}" href="https://www.linkedin.com/in/hans-peter-diesing-3136b81a6" target="_blank" class="">
            ...
            <a alt="{{ __('alt.discord') }}" href="https://www.discordapp.com/users/640313822145675287" target="_blank" class="">
