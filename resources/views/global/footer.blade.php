<footer class="bg-white border-t border-gray-200 py-8 dark:border-gray-700 dark:text-white dark:bg-gray-900">
    <div class="container mx-auto text-center">
        ...
        <div class="flex justify-center space-x-8 mb-4">
            <a alt="{{ __('alt.github') }}" title="{{ __('alt.github') }}" href="https://gitlab.com/hapediesing-group" target="_blank" class="">
                <svg class="h-8 w-8 dark:fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48px" height="48px"><path d="M12,2C6.477,2,2,6.486,2,12.021c0,4.425,2.865,8.18,6.839,9.504c0.5,0.092,0.682-0.217,0.682-0.482 c0-0.237-0.009-0.865-0.014-1.697c-2.782,0.605-3.369-1.343-3.369-1.343c-0.454-1.155-1.109-1.464-1.109-1.464 c-0.909-0.621,0.069-0.608,0.069-0.608c1.004,0.071,1.532,1.032,1.532,1.032c0.893,1.531,2.341,1.089,2.91,0.834 c0.091-0.647,0.35-1.089,0.636-1.34c-2.22-0.253-4.555-1.113-4.555-4.951c0-1.093,0.39-1.988,1.029-2.688 C5.729,8.366,5.4,7.482,5.948,6.197c0,0,0.84-0.27,2.75,1.026C9.564,6.957,10.782,6.804,12,6.798 c1.218,0.006,2.436,0.159,3.303,0.425c1.909-1.296,2.748-1.026,2.748-1.026c0.549,1.285,0.22,2.169,0.108,2.398 c0.64,0.7,1.028,1.595,1.028,2.688c0,3.848-2.338,4.695-4.566,4.943c0.36,0.312,0.679,0.927,0.679,1.869 c0,1.349-0.012,2.438-0.012,2.769c0,0.268,0.18,0.58,0.688,0.481C19.138,20.198,22,16.444,22,12.021C22,6.486,17.522,2,12,2z"/></svg>
            </a>
