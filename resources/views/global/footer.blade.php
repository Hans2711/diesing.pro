<footer class="bg-white border-t border-gray-200 py-8 dark:border-gray-700 dark:text-white dark:bg-gray-900">
    <div class="container mx-auto text-center">
        ...
        <div class="flex justify-center space-x-8 mb-4">
            <a href="https://www.instagram.com/hans.dsg" target="_blank" class="">
            ...
            <a href="https://www.linkedin.com/in/hans-peter-diesing-3136b81a6" target="_blank" class="">
            ...
            <a href="https://www.discordapp.com/users/640313822145675287" target="_blank" class="">
