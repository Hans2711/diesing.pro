<svg id="logo-svg" class="h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 -1 817 459">
    <defs>
        <mask id="letters-mask" maskUnits="userSpaceOnUse">
            ...
            <path id="pathP" d="M 397.62,164.50
                ...
                397.62,195.83 397.62,180.17 397.62,164.50 Z" fill="black"/>
            <path id="pathD" d="M 602.50,210.17
                ...
                587.68,268.64 598.85,240.98 602.50,210.17 Z" fill="black"/>
        </mask>
    </defs>
    <path id="Outline" d="M 610.00,-0.82
        ...
        348.83,0.51 479.50,0.18 610.00,-0.82 Z" fill="#fa322f" class="animate-outline" stroke="none" mask="url(#letters-mask)"/>
</svg>

<style>
#Outline {
    stroke-dasharray: 4800; /* Approximate the total length of the path */
    stroke-dashoffset: 4800;
    stroke: #fa322f; /* Set the stroke color */
    stroke-width: 15; /* Set the stroke width */
    fill: transparent; /* Initially, don't fill */
}
...
from {
    fill: transparent;
    stroke: #fa322f; /* Keep the stroke visible during the draw */
}
to {
    fill: #fa322f;
    stroke: transparent; /* Hide the stroke after filling */
}
}
</style>
