...
return [
    ...
    "contact" => implode(', ', [
        ...
        "consulting", "project request", "imprint", "address", "phone", "LinkedIn",
        "Xing", "social media", "business inquiry"
    ]),
    ...
    "notes" => implode(', ', [
        ...
        "markdown notes", "text editor", "to-do", "task list", "reminder"
    ]),
    "redirects" => implode(', ', [
        "redirects", "custom redirects", "URL shortener", "link shortener",
        "301 redirect", "302 redirect", "SEO redirect", "link management",
        "canonical URL"
    ]),
    "rt-share" => implode(', ', [
        "real-time share", "P2P file transfer", "WebRTC", "text sharing",
        "file transfer", "peer-to-peer", "secure transfer", "zero-storage",
        "direct link"
    ]),
    "data-protection" => implode(', ', [
        "data protection", "privacy policy", "GDPR", "data processing",
        "data security", "encryption", "cookie policy", "tracking",
        "analytics privacy"
    ]),
    "imprint" => implode(', ', [
        "imprint", "legal information", "contact info", "provider identification",
        "company", "address", "managing director", "registration court", "VAT ID"
    ]),
    "cv" => implode(', ', [
        "CV", "curriculum vitae", "resume", "HP Diesing",
