...
return [
    "home" => implode(', ', [
        "HP Diesing", "Softwareentwickler", "Webentwicklung", "PHP", "TYPO3", "Laravel", "JavaScript", "HTML5", "CSS3",
    ...
    "contact" => implode(', ', [
        ...
        "Beratung", "Projektanfrage", "Impressum", "Adresse", "Telefon", "LinkedIn",
        "Xing", "Social Media", "Netzwerk", "Geschäftsanfrage"
    ]),
    "random-teams" => implode(', ', [
    ...
    "notes" => implode(', ', [
        ...
        "Markdown-Notizen", "Text-Editor", "To-Do", "Aufgabenliste", "Reminder"
    ]),
    "redirects" => implode(', ', [
        "Weiterleitungen", "Custom Redirects", "URL Kurzlink", "Linkverkürzer",
        "301 Redirect", "302 Redirect", "SEO Redirect", "Link Management", "Canonical URL"
    ]),
    "rt-share" => implode(', ', [
        "Echtzeit teilen", "P2P Dateiübertragung", "WebRTC", "Text teilen",
        "Datei senden", "Peer-to-Peer", "Secure Transfer", "Zero-Storage", "Direct Link"
    ]),
    "data-protection" => implode(', ', [
        "Datenschutz", "Datenschutzerklärung", "Privacy Policy", "DSGVO", "GDPR",
        "Datenverarbeitung", "Datensicherheit", "Verschlüsselung", "Cookie-Richtlinie",
        "Tracking", "Analytics Privacy"
    ]),
    "imprint" => implode(', ', [
        "Impressum", "Rechtliche Informationen", "Kontaktinformation", "Anbieterkennzeichnung",
        "Firma", "Adresse", "Geschäftsführer", "Registergericht", "USt-IdNr."
    ]),
    "cv" => implode(', ', [
