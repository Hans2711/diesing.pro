...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.available_locales.English' => 'string',
            'app.available_locales.German' => 'string',
            ...
            'filesystems.links./home/diesi/diesing.pro/public/storage' => 'string',
...
'app.aliases.Vite','app.available_locales.English','app.available_locales.German','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.links./home/diesi/diesing.pro/public/storage','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','sitemap.guzzle_options.cookies','sitemap.guzzle_options.connect_timeout','sitemap.guzzle_options.timeout',
'sitemap.guzzle_options.allow_redirects','sitemap.execute_javascript','sitemap.chrome_binary_path','sitemap.crawl_profile','ide-helper.filename',
...
'livewire.update','livewire.upload-file','livewire.preview-file','grant','de.home','de.imprint','de.dataProtection',
'de.portfolio','de.contactForm','de.contactForm','de.testerAuth','de.testerAuthPost',
'de.testerDiff','de.testerObject','de.testerIndex','de.testerObject','de.testerRun',
'de.testerInstance','de.testerFetch','de.teams','de.rt-share','de.cv',
'en.home','en.imprint','en.dataProtection','en.portfolio','en.contactForm',
'en.contactForm','en.testerAuth','en.testerAuthPost','en.testerDiff','en.testerObject',
'en.testerIndex','en.testerObject','en.testerRun','en.testerInstance','en.testerFetch',
'en.teams','en.rt-share','en.cv','grant',
'ungrant','publicNote','publicRedirect','de.account','de.timetrack',
'de.notes','de.redirects','de.portfolio','de.cv','de.timetracking',
'de.timetracking-edit','de.rss-feeds','en.account','en.timetrack','en.notes',
'en.redirects','en.portfolio','en.cv','en.timetracking','en.timetracking-edit',
'en.rss-feeds',);
        registerArgumentsSet('views', 
'accounts.cv','accounts.email.request-access','accounts.index','accounts.index-auth','accounts.notes',
'accounts.portfolio','accounts.redirects','accounts.rss-feeds','accounts.timetrack','accounts.timetracking',
'accounts.timetracking-edit','accounts.tools-sidebar','contact.confirmation','contact.email','contact.form',
'cv.content','cv.index','cv.print','cv.single','datenschutz',
'global.footer','global.head.app-css-preload','global.head.font-preload','global.head.google-analytics','global.head.og-tags',
'global.head.title','global.head.translations','global.head.viewport','global.header','global.logo',
'global.partials.floating-label-input','home','impressum','layouts.account','layouts.app',
'layouts.email','layouts.minimal','livewire.account','livewire.account-auth','livewire.contact-form',
'livewire.cv-edit','livewire.notes','livewire.portfolio','livewire.portfolio-edit','livewire.random-teams',
'livewire.redirects','livewire.rss-feeds','livewire.testobject','livewire.testobject-diff','livewire.testobjects',
'livewire.testrun','livewire.timetrack','livewire.timetrack-edit','livewire.timetrack-edit-single','portfolio.list',
'public.note','rss.email.new-item','rt-share.index','share.index','teams.index',
'tester.auth','tester.diff','tester.index','tester.instance','tester.objectdiff',
'tester.testobject','tester.testrun','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'sitemap::sitemapIndex.sitemap','sitemap::url','sitemap::video',);
        registerArgumentsSet('translations', 
'auth.failed','auth.password','auth.throttle','auth.authenticated','auth.not-authenticated',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','validation.custom.name.required',
'validation.custom.name.min','validation.custom.email.required','validation.custom.email.email','validation.custom.tel.required','validation.custom.tel.regex',
'validation.custom.message.required','validation.custom.message.min','validation.custom.recipient.required','validation.custom.recipient.in','alt.grant_access',
'alt.remove_access','alt.instagram','alt.linkedin','alt.discord','alt.netigo_logo',
'alt.bkh_logo','alt.lessing_logo','alt.open_menu','alt.close_menu','alt.send',
'alt.add','alt.back','alt.close','alt.delete','alt.edit',
'alt.view','alt.download','alt.sync','alt.save','alt.link',
'alt.shuffle','alt.login','alt.compare','alt.rss','descriptions.home',
'descriptions.portfolio','descriptions.contact','descriptions.random-teams','descriptions.account','descriptions.tester',
'descriptions.notes','descriptions.redirects','descriptions.rt-share','descriptions.data-protection','descriptions.imprint',
'descriptions.cv','descriptions.rss-feeds','language.svg','language.svg-en','language.svg-de',
'language.name','language.name-en','language.name-de','language.locale-en','language.locale-de',
'text.welcome','text.contact','text.contact-description','text.message-sent','text.contact-confirmation-subject',
'text.contact-confirmation-body','text.select-recipient','text.portfolio','text.portfolio-description','text.tester-description',
'text.random-teams-description','text.private-tools','text.imprint','text.data-protection','text.and',
'text.all-rights-reserved','text.recipient','text.company','text.email','text.mobile',
'text.message','text.submit','text.save','text.submitting','text.ab-tester',
'text.tester','text.tester-disclaimer','text.password','text.new-testobject','text.testobject',
'text.testrun','text.testinstance','text.autodelete-after','text.1-day','text.7-days',
'text.1-month','text.never','text.created','text.deleted','text.back',
'text.instance-one','text.instance-two','text.empty','text.filled','text.crawl',
'text.fetch_all','text.bulk_diff','text.compare','text.hide_diff','text.show_diff',
'text.delete_all','text.sitemaps','text.run_sitemaps','text.crawl_completed','text.crawl_started',
'text.processed','text.fetch_started','text.fetch_already_dispatched','text.fetch_completed','text.all_deleted',
'text.random-teams','text.players','text.player-name','text.number-of-teams','text.today',
'text.are-you-sure','text.notes','text.redirects','text.share','text.copy_success',
'text.copy_failure','text.fallback_copy_success','text.fallback_copy_failure','text.account','text.account-description',
'text.tools','text.username_or_email','text.confirm_password','text.login_register','text.login',
'text.register','text.name','text.error','text.logged_in_as','text.username',
'text.permissions','text.permission_name','text.status','text.action','text.access_granted',
'text.no_access','text.request_access','text.logout','text.invalid_credentials','text.passwords_do_not_match',
'text.invalid_email','text.username_empty','text.name_empty','text.email_exists','text.username_exists',
'text.access_request_sent','text.account_text','text.saved','text.account_updated','text.edit',
'text.delete','text.users','text.private','text.user_deleted','text.permissions_updated',
'text.cv','text.cv-website','text.cv-description','text.print','text.rt-share',
'text.rt-share-description','text.open','text.overview','text.timetracking','text.rss-feeds',
'text.cv-headline','text.cv-intro','text.cv-section-personal','text.cv-fullname-label','text.cv-fullname',
'text.cv-nickname-label','text.cv-nickname','text.cv-birthday-label','text.cv-birthday','text.cv-nationality-label',
'text.cv-nationality','text.cv-contact-button','text.cv-section-experience','text.cv-backend-period','text.cv-backend-technologies-label',
'text.cv-backend-technologies','text.cv-backend-focus-label','text.cv-backend-focus','text.cv-backend-projects-label','text.cv-backend-projects',
'text.cv-apprenticeship-period','text.cv-apprenticeship-label','text.cv-apprenticeship-description','text.cv-section-education','text.cv-school1-period',
'text.cv-school1-field-label','text.cv-school1-field','text.cv-school2-period','text.cv-school2-field-label','text.cv-school2-field',
'text.cv-school2-degree-label','text.cv-school2-degree','text.cv-school2-advanced-label','text.cv-school2-advanced','text.cv-school2-basic-label',
'text.cv-school2-basic','text.cv-school3-period','text.cv-school3-degree-label','text.cv-school3-degree','text.cv-school4-name',
'text.cv-school4-period','text.cv-school4-degree-label','text.cv-school4-degree','text.cv-section-skills','text.cv-skills-intro',
'text.cv-skills-programming','text.cv-skills-frameworks','text.cv-skills-script-languages','text.cv-skills-web-styling','text.cv-skills-operating-systems',
'text.cv-skills-development-tools','text.cv-section-certificates','text.cv-certificate1-title','text.cv-certificate1-period','text.cv-certificate1-link',
'text.cv-section-languages','text.cv-lang-german','text.cv-lang-german-desc','text.cv-lang-english','text.cv-lang-english-desc',
'text.cv-lang-french','text.cv-lang-french-desc','text.cv-section-contact','text.cv-contact-link','text.cv-contact-phone-label',
'text.cv-contact-email-label','text.data-protection-page','text.imprint-page','titles.home','titles.portfolio',
'titles.contact','titles.random-teams','titles.account','titles.tester','titles.notes',
'titles.redirects','titles.data-protection','titles.imprint','titles.cv','titles.rt-share',
'titles.rss-feeds','url.contact','url.portfolio','url.tester','url.teams',
'url.imprint','url.data-protection','url.fingerprint','url.note','url.redirect',
'url.notes','url.redirects','url.files','url.account','url.cv',
'url.rt-share','url.timetracking','url.rss-feeds',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_TIMEZONE',
'APP_URL','PRIVATE_PASSWORD','TESTER_PASSWORD','ADMIN_USER','MAPS_API_KEY',
'REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET','VITE_REVERB_APP_KEY','VITE_REVERB_HOST',
'VITE_REVERB_PORT','VITE_REVERB_SCHEME','REVERB_SERVER_HOST','REVERB_SERVER_PORT','REVERB_HOST',
'REVERB_PORT','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
...
'SESSION_PATH','SESSION_DOMAIN','SESSION_SECURE_COOKIE','BROADCAST_CONNECTION','FILESYSTEM_DISK',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET',
