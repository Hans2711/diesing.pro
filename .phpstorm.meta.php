...
'validation.custom.message.required','validation.custom.message.min','validation.custom.recepient.required','validation.custom.recepient.in','alt.grant_access',
...
'text.contact-confirmation-body','text.select-recepient','text.portfolio','text.portfolio-description','text.tester-description',
'text.random-teams-description','text.private-tools','text.imprint','text.data-protection','text.and',
'text.all-rights-reserved','text.recepient','text.company','text.email','text.mobile',
'text.message','text.submit','text.save','text.submiting','text.ab-tester',
